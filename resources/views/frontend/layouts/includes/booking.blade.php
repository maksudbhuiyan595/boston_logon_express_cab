<style>
    ...
    /* TRIP TYPE */
    .trip-type-container { display: flex; gap: 6px; margin: 10px 0; }
    .trip-option { flex: 1; }
    ...
    .extra-row {
        ...
        margin-bottom: 6px;
        padding-bottom: 6px;
        border-bottom: 1px solid #2d3833;
    }
    ...
    .footer-note { text-align: center; font-size: 0.7rem; color: #fff; margin-top: 6px; margin-bottom: 0; }
        ...
        <div class="row hero-row justify-content-center">
            ...
            <div class="col-lg-7 ">
                <div class="description-column">
                    <p class="mb-1">
                       Boston Express Cab – Seamless Airport Transfers & Luxury City Rides
                    </p>
